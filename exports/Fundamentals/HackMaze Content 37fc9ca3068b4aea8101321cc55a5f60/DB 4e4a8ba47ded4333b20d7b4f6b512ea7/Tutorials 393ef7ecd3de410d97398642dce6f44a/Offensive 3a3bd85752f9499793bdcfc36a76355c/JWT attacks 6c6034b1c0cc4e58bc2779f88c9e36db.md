...
## By Mahmoud Hawash → [reach me on LinkedIn](https://www.linkedin.com/posts/juba0x00_jwt-attacks-activity-7113604710888091648-x3Ct?utm_source=share&utm_medium=member_desktop)

---

# [go to attacks, Skip Introduction](JWT%20attacks%206c6034b1c0cc4e58bc2779f88c9e36db.md)
...
![Untitled](JWT%20attacks%206c6034b1c0cc4e58bc2779f88c9e36db/Untitled.png)

![Untitled](JWT%20attacks%206c6034b1c0cc4e58bc2779f88c9e36db/Untitled%201.png)
...
[jwt.secrets.list](JWT%20attacks%206c6034b1c0cc4e58bc2779f88c9e36db/jwt.secrets.list)
...
add the certificate content on a `jwk` respecting the format mentioned in [x5c attribute in JWK is just a certificate with the following format:](JWT%20attacks%206c6034b1c0cc4e58bc2779f88c9e36db.md), we can sign using the private key and send the token with **`x5u`** header points to our jwk
...
![Untitled](JWT%20attacks%206c6034b1c0cc4e58bc2779f88c9e36db/Untitled%202.png)

- as shown above, we can add our JWK instead, like the following

![Untitled](JWT%20attacks%206c6034b1c0cc4e58bc2779f88c9e36db/Untitled%203.png)
...
- `Kernel.open/open` will run the filename as a command if the filename starts with a pipe | like the following `| echo "Command Injection" > /tmp/PoC.txt`
    ...
    ![Screenshot_20230928_124511.png](JWT%20attacks%206c6034b1c0cc4e58bc2779f88c9e36db/Screenshot_20230928_124511.png)
...
- Often used to retrieve a key from:
    - file system
    - database
- we talked about [→ **Injecting self-signed JWTs via the `kid` parameter**](JWT%20attacks%206c6034b1c0cc4e58bc2779f88c9e36db.md) above, let's talk about signing JWT with a known secret using SQLi
